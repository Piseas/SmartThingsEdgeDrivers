...
local is_zigbee_third_reality_humidity_sensor = function(opts, driver, device)
...
local third_reality_humdity_sensor = {
  ...
  can_handle = is_zigbee_third_party_humidity_sensor
}

return third_party_humdity_sensor
